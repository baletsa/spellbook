    ...
    init: function() {
      ...
      window.onload = function() {
        ...
        $.each(spellbook, function() {
          ...
          modalContent += '<div class="source"><span class="pages">' + this.page + ',</span><span class="class-tags"><strong>Available to:</strong> ' + this.class + '</span></div></div></div>' +
