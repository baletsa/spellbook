var jsonSpellData = [{
...

  {
    ...
    "oaths": "Devotion"
      ...
      "name": "Cause Fear",
      "desc": "<p>You awaken the sense of mortality in one creature you can see within range. The target must succeed on a Wisdom saving throw or become frightened for the duration. A target with 25 hit points or fewer makes the saving throw with disadvantage. The spell has no effect on constructs or undead.</p>",
      ...
      "name": "Ceremony",
      "desc": "<p>You perform one of several religious ceremonies. When you cast the spell, choose one of the following ceremonies, the target of which must be within 10 feet of you throughout the casting.</p><ul><li><b>Atonement:</b> You touch one willing creature whose alignment has changed, and you make a DC 20 Wisdom (Insight) check. On a success, you restore the target to its original alignment.</li><li><b>Bless Water:</b> You touch one flask of water and cause it to become holy water or unholy water.</li><li><b>Coming of Age:</b> You touch one humanoid old enough to be a young adult. For the next 24 hours, whenever the target makes an ability check, it can roll a d4 and add the number rolled to the ability check. A creature can benefit from this ceremony just once.</li><li><b>Dedication:</b> You touch one humanoid who would willingly convert to your religion or who wishes to be dedicated to your god’s service. For the next 24 hours, whenever the target makes a saving throw, it can roll a d4 and add the number rolled to the save. A creature can benefit from this ceremony just once.</li><li><b>Funeral Rite:</b> You bless one corpse within 5 feet of you. For the next 24 hours, the target can’t become undead by any means short of a wish spell.</li><li><b>Investiture:</b> You touch one willing humanoid. Choose one 1st-level spell you have prepared and expend a spell slot and any material components as if you were casting that spell. The spell has no effect. Instead, the target can cast this spell once without having to expend a spell slot or use material components. If the target doesn’t cast the spell within 1 hour, the invested spell is lost.</li><li><b>Marriage:</b> You touch adult humanoids willing to be bonded together in marriage. For the next 24 hours, each target gains a +2 bonus to AC and saving throws while they are within 30 feet of each other. A creature can benefit from this ceremony just once.</li></ul>",
      "page": "UA: Starter Spells",
      "range": "Touch",
      "components": "V, S, M",
      "material": "25gp worth of powdered silver.",
      "ritual": "yes",
      ...
      "name": "Chaos Bolt",
      "desc": "<p>You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 damage. Choose one of the d8s. The number it rolled determines the type of damage, as shown below.</p><ul><li><b>1:</b> Acid</li><li><b>2:</b> Cold</li><li><b>3:</b> Fire</li><li><b>4:</b> Force</li><li><b>5:</b> Lightning</li><li><b>6:</b> Poison</li><li><b>7:</b> Psychic</li><li><b>8:</b> Thunder</li></ul><p>If you roll the same number on both d8s, the chaotic energy leaps from the target to a different creature of your choice within 30 feet of it. Make a new attack roll against the new target, and make a new damage roll, which could cause the chaotic energy to leap again. A creature can be targeted only once by this mass of chaotic energy.</p>",
      "higher_level": "<p>When you cast this spell using a spell slot of 2nd level or higher, each target takes extra damage of the type rolled. The extra damage equals 1d6 for each slot level above 1st.</p>",
      "page": "UA: Starter Spells",
      "range": "120 feet",
      "components": "V, S",
      "ritual": "no",
      ...
      "name": "Guiding Hand",
      "desc": "<p>You create a Tiny incorporeal hand of shimmering light in an unoccupied space you can see within range. The hand exists for the duration, but it disappears if you teleport or you travel to a different plane of existence. When the hand appears, you name one major landmark, such as a city, mountain, castle, or battlefield on the same plane of existence as you. Someone in known history must have visited the site and mapped it. If the landmark appears on no map in existence, the spell fails. Otherwise, whenever you move toward the hand, it moves away from you at the same speed you moved, and it moves in the direction of the landmark, always remaining 5 feet away from you. If you don’t move toward the hand, it remains in place until you do and beckons for you to follow once every 1d4 minutes.</p>",
      "page": "UA: Starter Spells",
      "range": "5 feet",
      "components": "V, S",
      "ritual": "yes",
      ...
      "desc": "<p>You raise your hand, and burning radiance erupts from it. Each creature of your choice that you can see within 5 feet of you must succeed on a Constitution saving throw or take 1d6 radiant damage.</p><p>The spell’s damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).</p>",
      "page": "UA: Starter Spells",
      "range": "Self (5-foot radius)",
      "components": "V, S",
      "ritual": "no",
      ...
      "name": "Arcane Elixir",
      "desc": "<p>You create a simple healing elixir by infusing a specially prepared draught with arcane energy. The elixir retains its potency for the duration or until it’s consumed.</p><p>As an action, a creature can drink the elixir or administer it to another creature. The drinker regains 2d4 + 2 hit points.</p>",
      "page": "UA: Starter Spells",
      "range": "Self",
      "components": "V, S, M",
      "material": "alchemist's supplies and a container that can hold at least 4 ounces of liquid",
      "ritual": "no",
      "duration": "24 hours",
      "concentration": "no",
      "casting_time": "1 minute",
      ...
      "name": "Infestation",
      "desc": "<p>You cause highly agressive mites, fleas, and other parasites to appear momentarily on one creature you can see within range. The target must succeed on a Constitution saving throw or take 1d6 piercing damage. If the target takes any of that damage, the target moves 5 feet in a random direction if possible. Roll a d8 for the direction:</p> <ul><li><b>1:</b> north</li><li><b>2:</b> northeast</li><li><b>3:</b> east</li><li><b>4:</b> southeast</li><li><b>5:</b> south</li><li><b>6:</b> southwest</li><li><b>7:</b> west</li><li><b>8:</b> northwest</li></ul></p><p>The spell’s damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).</p>",
      "page": "UA: Starter Spells",
      "range": "30 feet",
      "components": "V, S, M",
      ...
      "name": "Puppet",
      "desc": "<p>Your gestures force one humanoid you can see within range to make a Charisma saving throw. On a failed save, the target must move up to its speed in a direction you choose. In addition, you can cause the target to drop whatever it is holding. This spell has no effect on a humanoid that is immune to being charmed.</p>",
      "page": "UA: Starter Spells",
      "range": "120 feet",
      "components": "S",
      "ritual": "no",
      ...
      "name": "Snare",
      "desc": "<p>While you cast this spell, you use the cord or rope to create a circle with a 5-foot radius on a flat surface within your reach. When you finish casting, the cord or rope disappears to become a magical trap.</p><p>The trap is nearly invisible and requires a successful Intelligence (Investigation) or Wisdom (Perception) check against your spell save DC to be found.</p><p>The trap triggers when a Small creature or larger moves into the area protected by the spell. The triggering creature must succeed on a Dexterity saving throw or fall prone and be hoisted into the air until it hangs upside down 3 feet above the protected surface, where it is restrained.</p><p>The restrained creature can make a Dexterity saving throw with disadvantage at the end of each of its turns and ends the restrained effect on a success. Alternatively, another creature that can reach the restrained creature can use an action to make an Intelligence (Arcana) check against your spell save DC. On a success, the restrained effect also ends.</p>",
      "page": "UA: Starter Spells",
      "range": "Self",
      "components": "V, S, M",
      "material": "30 feet of cord or rope, which is consumed by the spell",
      "ritual": "no",
      ...
      "name": "Nature's Aid",
      "desc": "<p>You call out to the spirits of nature to aid you. When you cast this spell, you can have the spirits perform one of the following effects:</p><ul><li>Show you any tracks on the ground within range. You make Wisdom (Survival) checks to follow these tracks with advantage for 1 hour or until you cast this spell again.</li><li>Show you any edible forage and clean drinking water within range.</li><li>Show you any suitable shelter for you and your companions with range.</li><li>Bring back wood for a fire and set up a campsite in the area using your supplies. The spirits build the fire in a circle of stones, put up tents, unroll bedrolls, and put out any rations and water for consumption.</li><li>Instantly break down a campsite, which includes putting out a fire, taking down tents, packing up bags, and burying any rubbish.</li></ul>",
      "page": "UA: Starter Spells",
      "range": "120 feet",
      "components": "V, S",
      "ritual": "yes",
      ...
      "name": "Zephyr Strike",
      "desc": "<p>You move like the wind. Your speed increases by 30 feet until the end of your turn and your movement doesn’t provoke opportunity attacks for the duration.</p><p>In addition, the first time you make a weapon attack on your turn before the spell ends, you make the attack roll with advantage.</p>",
      "page": "UA: Starter Spells",
      "range": "Self",
      "components": "V",
      "ritual": "no",
